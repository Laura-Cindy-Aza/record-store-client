...
const Cart = () => {
    return (
      ...
      <div className="container">
            ...
            <div className="dropdown is-hoverable">
              ...
              <span aria-haspopup="true" aria-controls="dropdown-menu4">
                ...
                <span className="icon is-small">
                  <i className="fa fa-angle-down" aria-hidden="true" before="dropdown"> </i>
                </span>
                 </span>
              </div>
              ...
              <section className="columns checkout">
                ...
                <div className="column submit-form">
                  ...
                  <div className="field is-grouped">
                    <p className="control">
                      <button className="button is-dark">Back to Dashboard</button>
                    </p>
                    <p className="control">
                      <button className="button is-link" href="#">Continue to checkout</button>
                    </p>
                  </div>
                </div>
              </section>
        ...
        <p className="has-text-centered">Copyright &copy; 2021. All Rights Reserved</p>
        </footer>
